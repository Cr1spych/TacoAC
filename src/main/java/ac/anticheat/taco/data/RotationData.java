...
public class RotationData extends Check implements PacketCheck {
    ...
    public RotationData(PlayerData playerData) {
        super("RotationData", playerData);
    }
    ...
    private void updateRotation(float newYaw, float newPitch) {
        ...
        float newDeltaYaw = Math.abs(yaw - lastYaw);
        float newDeltaPitch = Math.abs(pitch - lastPitch);
