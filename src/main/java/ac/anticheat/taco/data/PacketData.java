...
public class PacketData extends Check implements PacketCheck {
    ...
    public PacketData(PlayerData playerData) {
        super("PacketData", playerData);
    }
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Client.ENTITY_ACTION) {
            ...
            switch (wrapper.getAction()) {
                case START_SPRINTING -> lastSprintStart = nowNano;
                case STOP_SPRINTING -> lastSprintStop = nowNano;
                case START_FLYING_WITH_ELYTRA -> lastElytraStart = nowNano;
            }
        }
    }
